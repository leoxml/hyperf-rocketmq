...
class MQClient
{
     ...
     * @param null|Config $config config: necessary configs
     */
     ...
     * @param null|string $messageTag : filter tag for consumer. If not empty, only consume the message which's messageTag is equal to it.
     *
